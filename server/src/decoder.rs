//! ### JSON Decoder
//!
//! Use json decoder instead of protobuf decoder for support
//! with powerful serde library.
//!
//! Most of the codes are from [tonic example](https://github.com/hyperium/tonic/tree/master/examples/src/json-codec)
